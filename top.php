<?php 
    ...
    $cat_res=mysqli_query($con,"SELECT * FROM categories WHERE status=1 AND deleted='NO' ORDER BY categories asc LIMIT 3");
    $cat_arr=array();
                        ...
                        <div class="menumenu__container clearfix">
                                    ...
                                    <ul class="main__menu">
                                        ...
                                        <?php 
                                            foreach($cat_arr as $list){
                                                ?><li><a href="categories.php?id=<?php echo $list['id'];?>"><?php echo $list['categories'];?></a></li><?php
                                            }
                                        ?>
                            ...
                            <div class="col-md-4 col-lg-3 col-sm-5 col-xs-5">
                                <div class="header__right">
                                    <div class="search_new header_search search search_open">
