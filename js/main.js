    ...
    if(is_error==''){
        jQuery.ajax({
            ...
            success:function(result){
                ...
                if(result=='insert')
                {
                    jQuery('#register_msg p').html('Thank You For Registeration<br/>Please Login!');
                }
            }
        });
    }
...
function user_login(){
    ...
    if(login_email=="")
    {
        jQuery('#email_login_error').html('Please Enter Email');
        is_error='Yes';
    }
    if(login_password=="")
    {
        jQuery('#password_login_error').html('Please Enter Password');
        is_error='Yes';
    }
